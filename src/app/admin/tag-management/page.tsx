      ...
      <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg z-50">
        ...
        <nav className="mt-6">
          ...
          <div className="px-4 space-y-2">
            ...
            <a href="/admin/user-management" className="flex items-center px-4 py-3 rounded-lg text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 transition">
              <Users className="w-5 h-5 mr-3" />
              <span>ユーザー管理</span>
            </a>
            <a href="/admin/portfolio-management" className="flex items-center px-4 py-3 rounded-lg text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 transition">
              <FileText className="w-5 h-5 mr-3" />
              <span>ポートフォリオ管理</span>
            </a>
            <a href="/admin/tag-management" className="flex items-center px-4 py-3 rounded-lg bg-indigo-600 text-white">
